...
export const agentTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: composeDescription({
      ...
      examples: {
        useWhen: "provisioning a new agent directly as a board user (bypasses approval flow)",
        dontUseWhen:
          "you are an agent hiring a specialist — use paperclip_create_agent_hire instead",
      },
      errors: [
