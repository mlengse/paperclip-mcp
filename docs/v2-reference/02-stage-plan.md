...
2. Per-status text includes the named recovery action (404 → "verify with paperclip_list_..."; 409 → checkout-specific hint; 500 on comments-after → Paperclip-bug note).
